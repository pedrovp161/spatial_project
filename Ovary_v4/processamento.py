...
for i in adatas_dir:
    ...
    adata.obs['total_counts'] = is_outlier(adata.obs['total_counts']).astype(str) # total_counts é o numero de reads e é o equivalente a n_counts
    adata.obs['n_genes_by_counts'] = is_outlier(adata.obs['n_genes_by_counts']).astype(str) # n_genes_by_counts = n_genes
